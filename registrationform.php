...
Thank you for registering for ICHTD 2016. If you have requested any official letters, please allow up to 5 business days to receive your documents.
...
$your_subject = "Your Registration Details for ICHTD'16";

$your_headers = "From: ICHTD'16 <" . $my_email . ">";
...
<title>ICHTD'16 - Registration Form Filled!</title>
...
<div id="content">
  ...
  <header>
	...
	<div class="cbp-af-inner">
        ...
        <div class="bg">
          <h1>International Conference on Heat<br> Transfer Devices (ICHTD'16)</h1>
 ...
 <div class="unit unit-s-3-4 unit-m-3-4 unit-l-3-4">
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      <h2 class="title">1</h2>
      <p class="bold">ICHTD 2016:</p>
      <p class="body">ICHTD 2016 will  be held in Ottawa, Canada on April 4 - 5, 2016.</p>
    </div>          
    <div>
      <h2 class="title">2</h2>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  <div class="unit-spacer content">
	...
	<p class="body">We are looking forward to seeing you at ICHTD'16!</p>
  </div>
</div>
...
<footer id="contact">
	...
	<div class="unit-spacer">
	<p class="body">For questions or comments regarding ICHTD'16, please fill out the form below:</p>
